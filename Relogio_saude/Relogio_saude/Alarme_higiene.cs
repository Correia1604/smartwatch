...
{
    public partial class Alarme_higiene : Form
    {
        ...
        public Alarme_higiene(string text)
        {
            InitializeComponent();
            form_aberto = text;
        }

        private void Alarme_higiene_Load(object sender, EventArgs e)
        {
        ...
        private void label1_Click(object sender, EventArgs e)
        {
            ...
            else if (form_aberto == "Alarme_medicacao")
            {
                this.Close();
                inicio.Show();
            }
